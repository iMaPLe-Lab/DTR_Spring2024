...
server_address = '192.168.50.149'  # Replace with the IP address of your ESP32
server_port = 10000
...
try:
    ...
    while not done:
        ...
        left_y = apply_deadzone(0)
        right_x = apply_deadzone(0)
        l2_trigger = apply_deadzone(0)
        r2_trigger = apply_deadzone(0)
